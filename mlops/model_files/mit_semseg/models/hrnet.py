...
class HRNetV2(nn.Module):
    ...
    def forward(self, x, return_feature_maps=False):
        ...
        x_list = []
        for i, sub_transition1 in enumerate(self.transition1):
            if sub_transition1 is not None:
                x_list.append(sub_transition1(x))
            else:
                x_list.append(x)                
        ...
        # for module in self.stage2(x_list):
        #     x = module(x)


        x_list = []
        for i, sub_transition2 in enumerate(self.transition2):
            if sub_transition2 is not None:
                x_list.append(sub_transition2(y_list[-1]))
            else:
        ...
        x_list = []
        for i, sub_transition3 in enumerate(self.transition3):
            if sub_transition3 is not None:
                x_list.append(sub_transition3(y_list[-1]))
            else:
                x_list.append(y_list[i]) 
