...
# set image preprocessing filter (resize_and_padding, padding, or resize: str)
_C.DATASET.preprocess = None
# set scaling percentage for image preprocessing filter (decimal value: float) 
_C.DATASET.scaling_perc = 0.8
# set border padding for image preprocessing filter (pixel width: int) 
_C.DATASET.border_padding = 100
# change rotation of input image (rotate_clockwise or rotate_counterclockwise: str)
_C.DATASET.rotate = False
# flip input image horizontally (e.g. make right facing images face left) (True/False; bool)
